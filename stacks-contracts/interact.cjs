...
async function runInteractions() {
  ...
  const baseNonce = await getNextNonce(senderKey === '2f9b1e99d02be533a4e9c8d5c8143af7f528e477980e4de799d8e8bfaf5b2f6601' ? 'SP34MN3DMM07BNAWYJSHTS4B08T8JRVK8AT810X1B' : ''); // Mapping key to address for mempool check
